...
$string['federation_logo_help'] = 'Valfri bild för inloggningsknappen. Används när knappvisningen inkluderar logotypen.';
$string['federation_buttondisplay'] = 'Visning av inloggningsknapp';
$string['federation_buttondisplay_help'] = 'Som standard visas logotypen när en har laddats upp, annars visas etiketten. Du kan också visa logotypen före etiketten. Om det inte finns någon logotyp visas bara etiketten.';
$string['federation_buttondisplay_auto'] = 'Logotyp om uppladdad, annars etikett';
$string['federation_buttondisplay_both'] = 'Logotyp och etikett';
$string['federation_buttondisplay_invalid'] = 'Välj en giltig visning av inloggningsknappen.';
$string['federation_alwaysactive'] = 'Aktiv. En konfigurerad federation är alltid en aktiv IdP.';
