...
$string['federation_logo_help'] = 'Valfritt bilete for innloggingsknappen. Vert brukt når knappvisinga inkluderer logoen.';
$string['federation_buttondisplay'] = 'Visning av innloggingsknapp';
$string['federation_buttondisplay_help'] = 'Som standard vert logoen vist når ein er lasta opp, elles vert etiketten vist. Du kan også vise logoen føre etiketten. Viss det ikkje finst ein logo, vert berre etiketten vist.';
$string['federation_buttondisplay_auto'] = 'Logo viss lasta opp, elles etikett';
$string['federation_buttondisplay_both'] = 'Logo og etikett';
$string['federation_buttondisplay_invalid'] = 'Vel ei gyldig vising av innloggingsknappen.';
$string['federation_alwaysactive'] = 'Aktiv. Ein konfigurert føderasjon er alltid ein aktiv IdP.';
