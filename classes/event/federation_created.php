 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class federation_created extends base {
    ...
    public static function get_name() {
        return get_string('eventfederationcreated', 'auth_saml2');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' created the SAML2 federation with id '$this->objectid' " .
