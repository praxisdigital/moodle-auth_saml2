...
$string['federation_add'] = 'Add federated login';
$string['federation_add_help'] = 'Configure one or more federations (e.g. HAKA, eduGAIN). Each federation gets its own login button that sends the user to that federation\'s discovery service. This is separate from the global $CFG->auth_saml2_disco_url setting.';
$string['federation_manage'] = 'Manage federated logins';
$string['federation_edit'] = 'Edit federated login';
$string['federation_remove'] = 'Remove federated login';
$string['federation_save'] = 'Save configuration';
$string['federation_shortname'] = 'Federation shortname';
$string['federation_shortname_help'] = 'Unique short name without spaces (e.g. HAKA or eduGAIN). Used in the login URL.';
$string['federation_shortname_invalid'] = 'Shortname cannot contain spaces or special characters. Use letters, numbers, dots, underscores or hyphens only.';
$string['federation_shortname_exists'] = 'A federation with this shortname already exists.';
$string['federation_metadataurl'] = 'Federation metadata URL';
$string['federation_metadataurl_help'] = 'Public URL of the federation metadata XML (e.g. https://haka.funet.fi/metadata/haka-metadata-v10.xml). Used when establishing the login session after discovery.';
$string['federation_discourl'] = 'Federation discovery service URL';
$string['federation_discourl_help'] = 'URL of the federation IdP discovery service (e.g. https://haka.funet.fi/DS). Users are redirected here when they click the federation login button.';
$string['federation_buttonlabel'] = 'Login button label';
$string['federation_buttonlabel_help'] = 'Text shown on the Moodle login page for this federation.';
$string['federation_logo'] = 'Login button logo';
$string['federation_logo_help'] = 'Optional image for the login button. Used when the button display includes the logo.';
$string['federation_buttondisplay'] = 'Login button display';
$string['federation_buttondisplay_help'] = 'By default the logo is shown when one is uploaded, otherwise the label is shown. You can also show the logo before the label. If there is no logo, only the label is shown.';
$string['federation_buttondisplay_auto'] = 'Logo if uploaded, otherwise label';
$string['federation_buttondisplay_both'] = 'Logo and label';
$string['federation_buttondisplay_invalid'] = 'Select a valid login button display.';
$string['federation_alwaysactive'] = 'Active. A configured federation is always an active IdP.';
$string['federation_info'] = 'Federated logins are independent of selected IdPs. Each federation adds a login button that uses its own discovery service and metadata. Existing IdP configuration is unchanged. The global $CFG->auth_saml2_disco_url still applies when no federation button is used.';
$string['federation_none'] = 'No federated logins configured yet.';
$string['federation_saved'] = 'Federated login saved.';
$string['federation_deleted'] = 'Federated login removed.';
$string['federation_deleteconfirm'] = 'Are you sure you want to remove the federated login "{$a}"?';
$string['federation_notfound'] = 'Federated login not found.';
$string['federation_invalidurl'] = 'Please enter a valid URL.';
$string['federation_unknown'] = 'Unknown federation: {$a}';
$string['federation_tenantunavailable'] = 'The federated login "{$a}" is not available for the current tenant.';
$string['federation_tenantavailability'] = 'Tenant availability';
$string['federation_tenantavailabilityfor'] = 'Tenant availability for \'{$a}\'';
$string['federation_tenantavailability_success'] = 'Federation tenant availability updated successfully';
$string['federation_tenantmode'] = 'Available for';
$string['federation_tenantmode_help'] = 'Controls which Moodle Workplace tenants can see and use this federation login button. Configure this from the list page using the tenant availability action. On sites without Workplace tenancy these settings are ignored.';
$string['federation_tenantmode_all'] = 'All tenants';
$string['federation_tenantmode_include'] = 'Only the following tenants';
$string['federation_tenantmode_exclude'] = 'All tenants except the following';
$string['federation_tenantmode_include_summary'] = 'Include ({$a})';
$string['federation_tenantmode_exclude_summary'] = 'Exclude ({$a})';
$string['federation_tenantids_include'] = 'Tenants included';
$string['federation_tenantids_exclude'] = 'Tenants excluded';
$string['federation_tenantids_required'] = 'Select at least one tenant.';
$string['federation_editnamed'] = 'Edit federated login: {$a}';
$string['federation_createnew'] = 'Create new federated login';
$string['federation_enabled'] = 'Federated login enabled.';
$string['federation_disabled'] = 'Federated login disabled.';
$string['federation_disabled_error'] = 'The federated login "{$a}" is disabled.';
$string['federation_metadatastatus'] = 'Metadata';
$string['federation_metadatastatus_help'] = 'Whether the federation metadata XML has been downloaded and cached successfully.';
$string['federation_metadatastatus_ok'] = 'Metadata cached';
$string['federation_metadatastatus_missing'] = 'Metadata missing';
$string['eventfederationcreated'] = 'SAML2 federation created';
$string['eventfederationupdated'] = 'SAML2 federation updated';
$string['eventfederationdeleted'] = 'SAML2 federation deleted';
$string['eventfederationtenantavailabilityupdated'] = 'SAML2 federation tenant availability updated';
...
$string['keysize'] = 'Key size';
$string['keysize_help'] = 'Sets the bit size of the public/private keys used to generate and sign the certificate.';
