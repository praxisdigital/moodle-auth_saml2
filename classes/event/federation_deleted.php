 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class federation_deleted extends base {
    ...
    /**
     * Create event from a federation record (call before deleting the row).
     *
    ...
    public static function get_name() {
        return get_string('eventfederationdeleted', 'auth_saml2');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' deleted the SAML2 federation with id '$this->objectid' " .
